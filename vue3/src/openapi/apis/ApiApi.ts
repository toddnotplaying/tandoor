...
import {
    ...
    PaginatedRecipeImageItemListFromJSON,
    PaginatedRecipeImageItemListToJSON,
...
export interface ApiAiStepSortCreateRequest {
    recipe: Omit<Recipe, 'image'|'images'|'created_by'|'created_at'|'updated_at'|'food_properties'|'rating'|'last_cooked'>;
    provider?: number;
}
...
export interface ApiInviteLinkCreateRequest {
    inviteLink: Omit<InviteLink, 'uuid'|'used_by'|'created_by'|'created_at'>;
}
...
export interface ApiInviteLinkPartialUpdateRequest {
    id: number;
    patchedInviteLink?: Omit<PatchedInviteLink, 'uuid'|'used_by'|'created_by'|'created_at'>;
}
...
export interface ApiRecipeDeleteExternalPartialUpdateRequest {
    id: number;
    patchedRecipe?: Omit<PatchedRecipe, 'image'|'images'|'created_by'|'created_at'|'updated_at'|'food_properties'|'rating'|'last_cooked'>;
}
...
export interface ApiRecipeImageReorderUpdateRequest {
    recipe: number;
    order: Array<number>;
}
...
export interface ApiRecipeImageSetPrimaryUpdateRequest {
    id: number;
    recipe: number;
    createdAt: Date;
    updatedAt: Date;
...
export interface ApiRecipeImageUpdate2Request {
    id: number;
    image?: string;
    imageUrl?: string;
}
...
export class ApiApi extends runtime.BaseAPI {
     ...
     */
    async apiRecipeImageCreateRaw(requestParameters: ApiRecipeImageCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImageItem>> {
        if (requestParameters['recipe'] == null) {
            throw new runtime.RequiredError(
                'recipe',
        ...
        if (requestParameters['updatedAt'] == null) {
            throw new runtime.RequiredError(
                'updatedAt',
                'Required parameter "updatedAt" was null or undefined when calling apiRecipeImageCreate().'
            );
        }
        ...
        if (requestParameters['sortOrder'] != null) {
            formParams.append('sort_order', requestParameters['sortOrder'] as any);
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RecipeImageItemFromJSON(jsonValue));
    }
     ...
     * Add a new image to a recipe
     */
    async apiRecipeImageCreate(requestParameters: ApiRecipeImageCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImageItem> {
     ...
     * List recipe images
     */
    async apiRecipeImageListRaw(requestParameters: ApiRecipeImageListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedRecipeImageItemList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedRecipeImageItemListFromJSON(jsonValue));
    }
     ...
     * List recipe images
     */
    async apiRecipeImageList(requestParameters: ApiRecipeImageListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedRecipeImageItemList> {
     ...
     * ViewSet for managing multiple images per recipe.
     */
    async apiRecipeImagePartialUpdateRaw(requestParameters: ApiRecipeImagePartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImageItem>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * ViewSet for managing multiple images per recipe.
     */
    async apiRecipeImagePartialUpdate(requestParameters: ApiRecipeImagePartialUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImageItem> {
        const response = await this.apiRecipeImagePartialUpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }

    /**
     * Reorder images for a recipe. Expects {\'recipe\': id, \'order\': [id1, id2, ...]}
     * Reorder images for a recipe
     */
    async apiRecipeImageReorderUpdateRaw(requestParameters: ApiRecipeImageReorderUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ReorderResponse>> {
        if (requestParameters['recipe'] == null) {
            throw new runtime.RequiredError(
                'recipe',
                'Required parameter "recipe" was null or undefined when calling apiRecipeImageReorderUpdate().'
            );
        }
        ...
        if (requestParameters['order'] == null) {
            throw new runtime.RequiredError(
                'order',
                'Required parameter "order" was null or undefined when calling apiRecipeImageReorderUpdate().'
            );
        }
        ...
        if (requestParameters['order'] != null) {
            formParams.append('order', requestParameters['order']!.join(runtime.COLLECTION_FORMATS["csv"]));
        }

        const response = await this.request({
            path: `/api/recipe-image/reorder/`,
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => ReorderResponseFromJSON(jsonValue));
    }
     ...
     * Reorder images for a recipe
     */
    async apiRecipeImageReorderUpdate(requestParameters: ApiRecipeImageReorderUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ReorderResponse> {
        const response = await this.apiRecipeImageReorderUpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get a recipe image
     */
    async apiRecipeImageRetrieveRaw(requestParameters: ApiRecipeImageRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImageItem>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
     ...
     * Get a recipe image
     */
    async apiRecipeImageRetrieve(requestParameters: ApiRecipeImageRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImageItem> {
     ...
     */
    async apiRecipeImageSetPrimaryUpdateRaw(requestParameters: ApiRecipeImageSetPrimaryUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImageItem>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling apiRecipeImageSetPrimaryUpdate().'
            );
        }
        ...
        if (requestParameters['recipe'] == null) {
            throw new runtime.RequiredError(
                'recipe',
                'Required parameter "recipe" was null or undefined when calling apiRecipeImageSetPrimaryUpdate().'
            );
        }
        ...
        if (requestParameters['createdAt'] == null) {
            throw new runtime.RequiredError(
                'createdAt',
                'Required parameter "createdAt" was null or undefined when calling apiRecipeImageSetPrimaryUpdate().'
            );
        }
        ...
        if (requestParameters['updatedAt'] == null) {
            throw new runtime.RequiredError(
                'updatedAt',
                'Required parameter "updatedAt" was null or undefined when calling apiRecipeImageSetPrimaryUpdate().'
            );
        }
        ...
        if (requestParameters['createdBy'] == null) {
            throw new runtime.RequiredError(
                'createdBy',
                'Required parameter "createdBy" was null or undefined when calling apiRecipeImageSetPrimaryUpdate().'
            );
        }
        ...
        const response = await this.request({
            path: `/api/recipe-image/{id}/set_primary/`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters['id']))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: formParams,
     ...
     * Set an image as primary
     */
    async apiRecipeImageSetPrimaryUpdate(requestParameters: ApiRecipeImageSetPrimaryUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImageItem> {
        const response = await this.apiRecipeImageSetPrimaryUpdateRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async apiRecipeImageUpdateRaw(requestParameters: ApiRecipeImageUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImageItem>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
        ...
        if (requestParameters['updatedAt'] == null) {
            throw new runtime.RequiredError(
                'updatedAt',
                'Required parameter "updatedAt" was null or undefined when calling apiRecipeImageUpdate().'
            );
        }
     ...
     * Update a recipe image
     */
    async apiRecipeImageUpdate(requestParameters: ApiRecipeImageUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImageItem> {
     ...
     * logs request counts to redis cache total/per user/
     */
    async apiRecipeImageUpdate2Raw(requestParameters: ApiRecipeImageUpdate2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RecipeImage>> {
        if (requestParameters['id'] == null) {
            throw new runtime.RequiredError(
                'id',
                'Required parameter "id" was null or undefined when calling apiRecipeImageUpdate2().'
            );
        }
     ...
     * logs request counts to redis cache total/per user/
     */
    async apiRecipeImageUpdate2(requestParameters: ApiRecipeImageUpdate2Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RecipeImage> {
        const response = await this.apiRecipeImageUpdate2Raw(requestParameters, initOverrides);
        return await response.value();
    }
